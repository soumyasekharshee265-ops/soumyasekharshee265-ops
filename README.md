...
`Python` `Flask` `HTML/CSS/JS`<br>
🔗 Repo: https://github.com/soumyasekharshee265-ops/Billing-System<br>
...
🔗 Repo: https://github.com/soumyasekharshee265-ops/Quick-Hire-Pro<br>
...
`HTML5` `CSS3` `JavaScript` `Wotnot Chatbot Widget`<br>
🔗 Repo: https://github.com/soumyasekharshee265-ops/Hireme.bot<br>
...
`HTML5` `CSS3` `JavaScript`<br>
🔗 Repo: https://github.com/soumyasekharshee265-ops/JobScan-AI<br>
...
`HTML` `Tailwind CSS` `JavaScript` `Flowise`<br>
🔗 Repo: https://github.com/soumyasekharshee265-ops/Arogya-Krishi<br>
...
<p align="center">
  <i>"In a world drowning in data, the real edge is knowing which numbers actually matter."</i>
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=soumyasekharshee265-ops&style=flat-square&color=6C63FF" alt="Profile views" />
</p>
